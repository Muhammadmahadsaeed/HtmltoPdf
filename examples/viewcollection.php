...
if(isset($_GET['delete'])){
  $id = $_GET['delete'];
  $del = "select * from students where page_id = ".$id;
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <a href="./addProposal.php" class="btn pull-right" >Add Collection</a>
                            ...
                            <div class="card-body">
                                ...
                                <div class="container">
                                    <div class="row">
                                        <div class="col-md-12">
                                        <?php
                                        $selectStudents = "select * from collection";
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="./editproposals.php?edit=<?php echo $row['page_id'] ?>" class="btn">View</a>
